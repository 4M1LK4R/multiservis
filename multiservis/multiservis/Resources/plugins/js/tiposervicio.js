...
function Nuevo() {
    ...
    var codigo = '<p class="red-text text-darken-3 flow-text">CREAR NUEVO TIPO DE SERVICIO</p>';
...
function Guardar() {
    var i = $('#id').val();
    var nom = $('#nombre').val();
    $.getJSON("/TipoServicio/Guardar", { id: i, nombre: nom, estado: est }, function (e) {
        if (e != "") {
...
function Editar(id) {
    var o = { id: id };
    $.getJSON("/TipoServicio/Get", o, function (obj) {
...
function Listar() {
    $.getJSON("/TipoServicio/Listar", null, function (cadena) {
        $("#tabla").html(cadena);
        CrearDataTable();
    });
    $('#btnListar').show();    
...
$('#aceptarEliminar').click(function () {
    ...
    Materialize.toast('El tipo de servicio fue eliminado exitosamente!', 8000);
    Listar();
});
...
function Eliminar(id) {
    var o = { id: id };
    $.getJSON("/TipoServicio/Delete", o, function (e) {
        Listar();
    });
};
