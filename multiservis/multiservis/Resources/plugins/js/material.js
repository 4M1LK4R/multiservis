...
function Guardar() {
    ...
    est = true;
    $.getJSON("/Material/Guardar", { id: i, nombre: nom, id_servicio: id_serv, estado: est }, function (e) {
        if (e != "") {
...
function Editar(id) {
    var o = { id: id };
    $.getJSON("/Material/Get", o, function (obj) {
...
function Listar() {
    $.getJSON("/Material/Listar", null, function (cadena) {
        $("#tabla").html(cadena);
        CrearDataTable();
    });
    $('#btnListar').show();
...
$('#aceptarEliminar').click(function () {
    ...
    Materialize.toast('El material fue eliminado exitosamente!', 8000);
    Listar();
});
...
function Eliminar(id) {
    var o = { id: id };
    $.getJSON("/Material/Delete", o, function (e) {
        Listar();
    });
};
